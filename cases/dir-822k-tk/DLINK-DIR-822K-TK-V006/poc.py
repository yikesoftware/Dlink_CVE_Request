...
def main():
    parser = argparse.ArgumentParser(description='WPS repeater PIN command injection (WPS enabled branch)')
    ...
    parser.add_argument('--nonce', default='DLINK-DIR-822K-TK-V006')
